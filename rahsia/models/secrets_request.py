...
from rahsia.models.secret_request import SecretRequest
try:
...
class SecretsRequest(BaseModel):
    ...
    SecretsRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the group of secrets requested")
    namespace: StrictStr = Field(description="Location/namespace for the requested secrets")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SecretsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SecretsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "secrets": [SecretRequest.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
